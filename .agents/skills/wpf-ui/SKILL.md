...
From WPF UI Gallery and Codex Desktop skill - this is a production-ready pattern for dashboard stats:
...
## Improving Codex Family Manager v2

Based on the current Codex-family-manager-v2 UI, here are specific WPF UI improvements using patterns from this skill:
